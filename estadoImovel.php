					...
					<div class="col-lg-8">
                        <div class="row">
							...
							<?php 
								...
								$estado=$_REQUEST['id'];
								$query=mysqli_query($con,"SELECT imoveiss.*, usuarios.usuarioNome,usuarios.usuarioTipo,usuarios.usuarioImg FROM `imoveis`,`usuarios` WHERE imoveis.idUsuario=usuarios.idUsuario and estado='$estado'");
