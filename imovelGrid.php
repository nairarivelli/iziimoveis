    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Filtrar Imovel</b></h2>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Filtrar Imovel</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							{
								$imovelTipo=$_REQUEST['imovelTipo'];
								$locacao=$_REQUEST['locacao'];
								$cidade=$_REQUEST['cidade'];
								
								$sql="SELECT imoveis.*, usuarios.usuarioNome FROM `imoveis`,`usuarios` WHERE imoveis.idUsuario=usuarios.idUsuario and imovelTipo='{$imovelTipo}' and locacao='{$locacao}' and cidade='{$cidade}'";
              ...
              <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="imovesdetalhe.php?idImovel=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                            <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-success"></i> <?php echo $row['14'];?></span> </div>
                                        <div class="px-4 pb-4 d-inline-block w-100">
                                            <div class="float-left text-capitalize"><i class="fas fa-user text-success mr-1"></i>Por : <?php echo $row['uname'];?></div>
                            ...
                            <?php 		
									...
									echo "<h1 class='mb-5'><center>Sem propriedades disponiveis</center></h1>";
								}
                    ...
                    <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Imoveis adicionados recentemente</h4>
